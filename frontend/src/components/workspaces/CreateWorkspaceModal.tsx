...
export function CreateWorkspaceModal({ isOpen, onClose, users }: CreateWorkspaceModalProps) {
  ...
  const filteredUsers = useMemo(() => {
    ...
    return users
      .filter((u) => {
        ...
        return matchesDepartment && matches && notSelected;
      })
      .slice(0, 8);
        ...
        <div className="p-6 pb-4 border-b relative">
          ...
          <div className="pr-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Set up a shared space for documents and collaboration
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Optional short description of the workspace purpose"
              rows={3}
          ...
          <div className="space-y-3">
            ...
            <p className={cn('text-xs text-muted-foreground', selectedMembers.length === 0 && 'hidden')}>
